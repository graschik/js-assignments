...
function getRegexForIPv4() {
    return /^(0?0?[0-9]|0?\d\d|1\d\d|2[0-4]\d|25[0-5])\.((0?0?[0-9]|0?\d\d|1\d\d|2[0-4]\d|25[0-5])\.){2}(0?0?[0-9]|0?\d\d|1\d\d|2[0-4]\d|25[0-5])$/;
...
function getRegexForSSN() {
   return /(\d{2}[1-9]|\d[1-9]\d|[1-9]\d{2})-(\d[1-9]|[1-9]\d)-(\d{3}[1-9]|\d{2}[1-9]\d|\d[1-9]\d{2}\d[1-9]\d{3})/;
}
...
function getPasswordValidator(minLength) {
    var temp = new RegExp('^(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z])[0-9a-zA-Z]{' + minLength + ',}$');
    return temp;
}
